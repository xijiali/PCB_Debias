...
from reid.trainers_partloss import Trainer_6stripes
from reid.evaluators import Evaluator,Evaluator_6stripes
...
#        model.load_state_dict(checkpoint['state_dict'])
    ...
    if args.evaluate:
        ...
        evaluator_6stripes.evaluate(query_loader, gallery_loader,  dataset.query, dataset.gallery)
        return
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if ((epoch + 1) % args.eval_step == 0 or (epoch == args.epochs - 1)):
            R1,mAP=evaluator.evaluate(query_loader, gallery_loader, dataset.query, dataset.gallery)
...
if __name__ == '__main__':
    ...
    # training configs
    parser.add_argument('--resume', type=str, default='/gruntdata/xiaoxi.xjl/my_code/pcb_rpp/PCB_6stripes_Market/model59_checkpoint.pth.tar', metavar='PATH')
    ...
    parser.add_argument('--data-dir', type=str, metavar='PATH',
                        default='/gruntdata/xiaoxi.xjl/re_id_datasets/Market-1501-v15.09.15')
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'PCB_6stripes_Market_evaluator'))
